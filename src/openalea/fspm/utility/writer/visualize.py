...
def export_scene_to_gltf(output_path, plotter, off_screen, clim, colormap="jet", parallel_compression=True, log_scale=True):
    """
    ...
    export_plotter = pv.Plotter(off_screen=off_screen)
